...
@Slf4j
public class TerraswapTransactionVisitorMars extends SwapTransactionVisitor {
    ...
    protected ExtractedSwap getExtractedSwap(String txHash, MsgValue msgValue) {
        if (Coin.MARS.getContract().equals(msgValue.getContract()) || SwapPairs.TerraSwap.MARS_UST.equals(msgValue.getContract()))  {
